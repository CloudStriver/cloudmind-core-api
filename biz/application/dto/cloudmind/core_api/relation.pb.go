...
type CreateRelationReq struct {
	...
	ToType       TargetType   `protobuf:"varint,2,opt,name=toType,proto3,enum=cloudmind.core_api.TargetType" json:"toType" form:"toType" query:"toType"`
	RelationType RelationType `protobuf:"varint,3,opt,name=relationType,proto3,enum=cloudmind.core_api.RelationType" json:"relationType" form:"relationType" query:"relationType"`
}
...
type GetFromRelationsResp struct {
	...
	Posts []*OwnPost `protobuf:"bytes,2,rep,name=posts,proto3" json:"posts" form:"posts" query:"posts"`
}
...
type DeleteRelationReq struct {
	...
	ToId         string `protobuf:"bytes,1,opt,name=toId,proto3" json:"toId" form:"toId" query:"toId"`
	ToType       int64  `protobuf:"varint,2,opt,name=toType,proto3" json:"toType" form:"toType" query:"toType"`
	RelationType int64  `protobuf:"varint,3,opt,name=relationType,proto3" json:"relationType" form:"relationType" query:"relationType"`
}
...
var file_cloudmind_core_api_relation_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x42, 0x53, 0x5a, 0x51, 0x67, 0x69, 0x74, 0x68,
