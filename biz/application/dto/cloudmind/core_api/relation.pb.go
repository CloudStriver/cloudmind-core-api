...
func (x *DeleteRelationResp) Reset() {
	*x = DeleteRelationResp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cloudmind_core_api_relation_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_cloudmind_core_api_relation_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xf0, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3a,
...
var file_cloudmind_core_api_relation_proto_goTypes = []interface{}{
	...
	(*CreateRelationResp)(nil),   // 2: cloudmind.core_api.CreateRelationResp
	(*GetFromRelationsReq)(nil),  // 3: cloudmind.core_api.GetFromRelationsReq
	(*GetFromRelationsResp)(nil), // 4: cloudmind.core_api.GetFromRelationsResp
	...
	(*GetRelationReq)(nil),       // 7: cloudmind.core_api.GetRelationReq
...
func file_cloudmind_core_api_relation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cloudmind_core_api_relation_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
