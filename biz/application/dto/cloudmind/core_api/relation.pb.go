...
type CreateRelationReq struct {
	...
	ToType       TargetType   `protobuf:"varint,2,opt,name=toType,proto3,enum=cloudmind.core_api.TargetType" json:"toType" form:"toType" query:"toType" vd:"($ >= 1 && $ <= 2) || ($ == 4)"`
	RelationType RelationType `protobuf:"varint,3,opt,name=relationType,proto3,enum=cloudmind.core_api.RelationType" json:"relationType" form:"relationType" query:"relationType" vd:"($ >= 1 && $ <= 5"`
}
...
type GetFromRelationsReq struct {
	...
	FromType     int64      `protobuf:"varint,2,opt,name=fromType,proto3" json:"fromType" form:"fromType" query:"fromType" vd:"($ >= 1 && $ <= 2) || ($ == 4)"`
	ToType       TargetType `protobuf:"varint,3,opt,name=toType,proto3,enum=cloudmind.core_api.TargetType" json:"toType" form:"toType" query:"toType" vd:"($ >= 1 && $ <= 2) || ($ == 4)"`
	RelationType int64      `protobuf:"varint,4,opt,name=relationType,proto3" json:"relationType" form:"relationType" query:"relationType" vd:"($ >= 1 && $ <= 5"`
...
type GetToRelationsReq struct {
	...
	ToType       int64      `protobuf:"varint,1,opt,name=toType,proto3" json:"toType" form:"toType" query:"toType" vd:"($ >= 1 && $ <= 2) || ($ == 4)"`
	ToId         string     `protobuf:"bytes,2,opt,name=toId,proto3" json:"toId" form:"toId" query:"toId"`
	FromType     TargetType `protobuf:"varint,3,opt,name=fromType,proto3,enum=cloudmind.core_api.TargetType" json:"fromType" form:"fromType" query:"fromType" vd:"($ >= 1 && $ <= 2) || ($ == 4)"`
	RelationType int64      `protobuf:"varint,4,opt,name=relationType,proto3" json:"relationType" form:"relationType" query:"relationType" vd:"($ >= 1 && $ <= 5"`
	Limit        *int64     `protobuf:"varint,5,opt,name=limit,proto3,oneof" json:"limit" form:"limit" query:"limit"`
	Offset       *int64     `protobuf:"varint,6,opt,name=offset,proto3,oneof" json:"offset" form:"offset" query:"offset"`
}
...
type GetRelationReq struct {
	...
	ToType       int64  `protobuf:"varint,4,opt,name=toType,proto3" json:"toType" form:"toType" query:"toType" vd:"($ >= 1 && $ <= 2) || ($ == 4)"`
	RelationType int64  `protobuf:"varint,5,opt,name=relationType,proto3" json:"relationType" form:"relationType" query:"relationType" vd:"($ >= 1 && $ <= 5"`
}
...
type DeleteRelationReq struct {
	...
	ToId         string `protobuf:"bytes,1,opt,name=toId,proto3" json:"toId" form:"toId" query:"toId"`
	ToType       int64  `protobuf:"varint,2,opt,name=toType,proto3" json:"toType" form:"toType" query:"toType" vd:"($ >= 1 && $ <= 2) || ($ == 4)"`
	RelationType int64  `protobuf:"varint,3,opt,name=relationType,proto3" json:"relationType" form:"relationType" query:"relationType" vd:"($ >= 1 && $ <= 5"`
}
