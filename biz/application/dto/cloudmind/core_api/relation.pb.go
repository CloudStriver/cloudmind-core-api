...
type CreateRelationReq struct {
	...
	RelationType RelationType `protobuf:"varint,3,opt,name=relationType,proto3,enum=cloudmind.core_api.RelationType" json:"relationType" form:"relationType" query:"relationType" vd:"$ >= 1 && $ <= 7"`
}
...
type GetFromRelationsReq struct {
	...
	RelationType int64      `protobuf:"varint,4,opt,name=relationType,proto3" json:"relationType" form:"relationType" query:"relationType" vd:"$ >= 1 && $ <= 7"`
...
type GetToRelationsReq struct {
	...
	FromType     TargetType `protobuf:"varint,3,opt,name=fromType,proto3,enum=cloudmind.core_api.TargetType" json:"fromType" form:"fromType" query:"fromType" vd:"$ >= 1 && $ <= 3"`
	RelationType int64      `protobuf:"varint,4,opt,name=relationType,proto3" json:"relationType" form:"relationType" query:"relationType" vd:"$ >= 1 && $ <= 7"`
	Limit        *int64     `protobuf:"varint,5,opt,name=limit,proto3,oneof" json:"limit" form:"limit" query:"limit"`
	Offset       *int64     `protobuf:"varint,6,opt,name=offset,proto3,oneof" json:"offset" form:"offset" query:"offset"`
}
...
type GetRelationReq struct {
	...
	RelationType int64  `protobuf:"varint,5,opt,name=relationType,proto3" json:"relationType" form:"relationType" query:"relationType" vd:"$ >= 1 && $ <= 7"`
}
...
type DeleteRelationReq struct {
	...
	RelationType int64  `protobuf:"varint,3,opt,name=relationType,proto3" json:"relationType" form:"relationType" query:"relationType" vd:"$ >= 1 && $ <= 7"`
}
...
var file_cloudmind_core_api_relation_proto_rawDesc = []byte{
	...
	0x6e, 0x52, 0x65, 0x73, 0x70, 0x42, 0x53, 0x5a, 0x51, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
