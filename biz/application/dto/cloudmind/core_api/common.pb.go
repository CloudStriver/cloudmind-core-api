...
type File struct {
	...
	TypeString  string `protobuf:"bytes,4,opt,name=typeString,proto3" json:"typeString" form:"typeString" query:"typeString"`
	Type        Type   `protobuf:"varint,5,opt,name=type,proto3,enum=cloudmind.core_api.Type" json:"type" form:"type" query:"type"`
	Path        string `protobuf:"bytes,6,opt,name=path,proto3" json:"path" form:"path" query:"path"`
	FatherId    string `protobuf:"bytes,7,opt,name=fatherId,proto3" json:"fatherId" form:"fatherId" query:"fatherId"`
	SpaceSize   *int64 `protobuf:"varint,8,opt,name=spaceSize,proto3,oneof" json:"spaceSize" form:"spaceSize" query:"spaceSize"`
	Md5         string `protobuf:"bytes,9,opt,name=md5,proto3" json:"md5" form:"md5" query:"md5"`
	IsDel       int64  `protobuf:"varint,10,opt,name=isDel,proto3" json:"isDel" form:"isDel" query:"isDel"`
	Zone        string `protobuf:"bytes,11,opt,name=zone,proto3" json:"zone" form:"zone" query:"zone"`
	SubZone     string `protobuf:"bytes,12,opt,name=subZone,proto3" json:"subZone" form:"subZone" query:"subZone"`
	Description string `protobuf:"bytes,13,opt,name=description,proto3" json:"description" form:"description" query:"description"`
	Url         string `protobuf:"bytes,14,opt,name=url,proto3" json:"url" form:"url" query:"url"`
}
...
type FileInfo struct {
	...
	Path         string        `protobuf:"bytes,6,opt,name=path,proto3" json:"path" form:"path" query:"path"`
	FatherId     string        `protobuf:"bytes,7,opt,name=fatherId,proto3" json:"fatherId" form:"fatherId" query:"fatherId"`
	SpaceSize    int64         `protobuf:"varint,8,opt,name=spaceSize,proto3" json:"spaceSize" form:"spaceSize" query:"spaceSize"`
	Md5          string        `protobuf:"bytes,9,opt,name=md5,proto3" json:"md5" form:"md5" query:"md5"`
	IsDel        int64         `protobuf:"varint,10,opt,name=isDel,proto3" json:"isDel" form:"isDel" query:"isDel"`
	Zone         string        `protobuf:"bytes,11,opt,name=zone,proto3" json:"zone" form:"zone" query:"zone"`
	SubZone      string        `protobuf:"bytes,12,opt,name=subZone,proto3" json:"subZone" form:"subZone" query:"subZone"`
	...
	Author       *User         `protobuf:"bytes,17,opt,name=author,proto3" json:"author" form:"author" query:"author"`                         // 作者信息
	FileCount    *PostCount    `protobuf:"bytes,18,opt,name=fileCount,proto3" json:"fileCount" form:"fileCount" query:"fileCount"`             // 文章统计信息
	FileRelation *PostRelation `protobuf:"bytes,19,opt,name=fileRelation,proto3" json:"fileRelation" form:"fileRelation" query:"fileRelation"` // 文章关系信息
}
...
type FileFilterOptions struct {
	...
	OnlyTags         []string `protobuf:"bytes,5,rep,name=onlyTags,proto3" json:"onlyTags" form:"onlyTags" query:"onlyTags"`
	...
	OnlyTypeStrings  []string `protobuf:"bytes,8,rep,name=onlyTypeStrings,proto3" json:"onlyTypeStrings" form:"onlyTypeStrings" query:"onlyTypeStrings"`
}
...
var file_cloudmind_core_api_common_proto_rawDesc = []byte{
	...
	0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x10, 0x02, 0x42, 0x53, 0x5a, 0x51, 0x67, 0x69, 0x74, 0x68,
