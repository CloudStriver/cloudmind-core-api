...
type FileFilterOptions struct {
	...
	OnlyTags         []string `protobuf:"bytes,8,rep,name=onlyTags,proto3" json:"onlyTags" form:"onlyTags" query:"onlyTags"`
...
type Notification struct {
	...
	SourceUserId    string `protobuf:"bytes,2,opt,name=sourceUserId,proto3" json:"sourceUserId" form:"sourceUserId" query:"sourceUserId"`
	...
	IsRead          bool   `protobuf:"varint,6,opt,name=isRead,proto3" json:"isRead" form:"isRead" query:"isRead"`
...
type Content struct {
	...
	Id         string `protobuf:"bytes,1,opt,name=id,proto3" json:"id" form:"id" query:"id"`
	UserId     string `protobuf:"bytes,2,opt,name=userId,proto3" json:"userId" form:"userId" query:"userId"`         // 评论者
	AtUserId   string `protobuf:"bytes,3,opt,name=atUserId,proto3" json:"atUserId" form:"atUserId" query:"atUserId"` // @谁
	Content    string `protobuf:"bytes,4,opt,name=content,proto3" json:"content" form:"content" query:"content"`     // 内容
	Meta       string `protobuf:"bytes,5,opt,name=meta,proto3" json:"meta" form:"meta" query:"meta"`                 // 皮肤，字体等
...
type SubjectFilterOptions struct {
	...
	OnlyUserId    *string `protobuf:"bytes,1,opt,name=onlyUserId,proto3,oneof" json:"onlyUserId" form:"onlyUserId" query:"onlyUserId"`
	OnlyItemId    *string `protobuf:"bytes,2,opt,name=onlyItemId,proto3,oneof" json:"onlyItemId" form:"onlyItemId" query:"onlyItemId"`
	...
	OnlyState     *int64  `protobuf:"varint,4,opt,name=onlyState,proto3,oneof" json:"onlyState" form:"onlyState" query:"onlyState"`
	OnlyAttrs     *int64  `protobuf:"varint,5,opt,name=onlyAttrs,proto3,oneof" json:"onlyAttrs" form:"onlyAttrs" query:"onlyAttrs"`
}
...
type Subject struct {
	...
	TopCommentId string `protobuf:"bytes,4,opt,name=topCommentId,proto3" json:"topCommentId" form:"topCommentId" query:"topCommentId"`
	RootCount    *int64 `protobuf:"varint,5,opt,name=rootCount,proto3,oneof" json:"rootCount" form:"rootCount" query:"rootCount"`
	AllCount     *int64 `protobuf:"varint,6,opt,name=allCount,proto3,oneof" json:"allCount" form:"allCount" query:"allCount"`
	State        State  `protobuf:"varint,7,opt,name=state,proto3,enum=cloudmind.core_api.State" json:"state" form:"state" query:"state"` // 1: 正常, 2: 删除
	Attrs        Attrs  `protobuf:"varint,8,opt,name=attrs,proto3,enum=cloudmind.core_api.Attrs" json:"attrs" form:"attrs" query:"attrs"` // 1: 无, 2: 置顶, 3: 精华, 4: 置顶+精华
}
...
type SubjectDetails struct {
	...
	UserId       string `protobuf:"bytes,3,opt,name=userId,proto3" json:"userId" form:"userId" query:"userId"`
	TopCommentId string `protobuf:"bytes,4,opt,name=TopCommentId,proto3" json:"TopCommentId" form:"TopCommentId" query:"TopCommentId"`
	RootCount    int64  `protobuf:"varint,5,opt,name=rootCount,proto3" json:"rootCount" form:"rootCount" query:"rootCount"`
	AllCount     int64  `protobuf:"varint,6,opt,name=allCount,proto3" json:"allCount" form:"allCount" query:"allCount"`
	State        int64  `protobuf:"varint,7,opt,name=state,proto3" json:"state" form:"state" query:"state"` // 1: 正常, 2: 删除
	Attrs        int64  `protobuf:"varint,8,opt,name=attrs,proto3" json:"attrs" form:"attrs" query:"attrs"` // 1: 无, 2: 置顶, 3: 精华, 4: 置顶+精华
}
...
type SubjectInfo struct {
	...
	ItemId string `protobuf:"bytes,2,opt,name=itemId,proto3" json:"itemId" form:"itemId" query:"itemId"`
	UserId string `protobuf:"bytes,3,opt,name=userId,proto3" json:"userId" form:"userId" query:"userId"`
	Attrs  int64  `protobuf:"varint,4,opt,name=attrs,proto3" json:"attrs" form:"attrs" query:"attrs"` // 1: 无, 2: 置顶, 3: 精华, 4: 置顶+精华
}
...
type LabelEntity struct {
	...
	ObjectId   string   `protobuf:"bytes,1,opt,name=objectId,proto3" json:"objectId" form:"objectId" query:"objectId"`
	ObjectType int64    `protobuf:"varint,2,opt,name=objectType,proto3" json:"objectType" form:"objectType" query:"objectType"`
...
type ObjectFilterOptions struct {
	...
	OnlyLabelId    *string `protobuf:"bytes,1,opt,name=onlyLabelId,proto3,oneof" json:"onlyLabelId" form:"onlyLabelId" query:"onlyLabelId"`
	OnlyObjectType *int64  `protobuf:"varint,2,opt,name=onlyObjectType,proto3,oneof" json:"onlyObjectType" form:"onlyObjectType" query:"onlyObjectType"`
}
...
var file_cloudmind_core_api_common_proto_rawDesc = []byte{
	...
	0x06, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xc7, 0x02, 0x0a, 0x0b, 0x43, 0x6f, 0x6d, 0x6d,
	...
	0x72, 0x73, 0x22, 0x9d, 0x02, 0x0a, 0x14, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x46, 0x69,
	...
	,
	...
	0x05, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00, 0x52, 0x09, 0x72, 0x6f, 0x6f, 0x74, 0x43, 0x6f, 0x75,
	0x6e, 0x74, 0x88, 0x01, 0x01, 0x12, 0x1f, 0x0a, 0x08, 0x61, 0x6c, 0x6c, 0x43, 0x6f, 0x75, 0x6e,
	0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x48, 0x01, 0x52, 0x08, 0x61, 0x6c, 0x6c, 0x43, 0x6f,
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x6d, 0x69,
	...
	0x75, 0x6e, 0x74, 0x22, 0xda, 0x01, 0x0a, 0x0e, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x44,
	...
	,
	...
	,
	...
	0x83, 0x01, 0x0a, 0x0c, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65,
	...
	0x79, 0x70, 0x65, 0x10, 0x06, 0x2a, 0x39, 0x0a, 0x05, 0x49, 0x73, 0x44, 0x65, 0x6c, 0x12, 0x0b,
	...
	0x67, 0x68, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x65, 0x64, 0x10, 0x04, 0x42, 0x53, 0x5a, 0x51, 0x67,
...
var file_cloudmind_core_api_common_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
...
var file_cloudmind_core_api_common_proto_goTypes = []interface{}{
	...
	(*UserDetail)(nil),             // 7: cloudmind.core_api.UserDetail
	(*PrivateFile)(nil),            // 8: cloudmind.core_api.PrivateFile
	(*PublicFile)(nil),             // 9: cloudmind.core_api.PublicFile
	(*Zone)(nil),                   // 10: cloudmind.core_api.Zone
	(*ShareFile)(nil),              // 11: cloudmind.core_api.ShareFile
	(*ShareFileInfo)(nil),          // 12: cloudmind.core_api.ShareFileInfo
	(*ShareCode)(nil),              // 13: cloudmind.core_api.ShareCode
	(*SearchField)(nil),            // 14: cloudmind.core_api.SearchField
	(*SearchOptions)(nil),          // 15: cloudmind.core_api.SearchOptions
	(*FileFilterOptions)(nil),      // 16: cloudmind.core_api.FileFilterOptions
	(*ShareFileFilterOptions)(nil), // 17: cloudmind.core_api.ShareFileFilterOptions
	(*UserDetailInfo)(nil),         // 18: cloudmind.core_api.UserDetailInfo
	(*UserInfo)(nil),               // 19: cloudmind.core_api.UserInfo
	(*PostCount)(nil),              // 20: cloudmind.core_api.PostCount
	(*PostRelation)(nil),           // 21: cloudmind.core_api.PostRelation
	(*Post)(nil),                   // 22: cloudmind.core_api.Post
	(*OwnPost)(nil),                // 23: cloudmind.core_api.OwnPost
	(*Notification)(nil),           // 24: cloudmind.core_api.Notification
	(*Content)(nil),                // 25: cloudmind.core_api.Content
	(*IndexInfo)(nil),              // 26: cloudmind.core_api.IndexInfo
	(*Comment)(nil),                // 27: cloudmind.core_api.Comment
	(*CommentInfo)(nil),            // 28: cloudmind.core_api.CommentInfo
	(*CommentFilterOptions)(nil),   // 29: cloudmind.core_api.CommentFilterOptions
	(*SubjectFilterOptions)(nil),   // 30: cloudmind.core_api.SubjectFilterOptions
	(*Subject)(nil),                // 31: cloudmind.core_api.Subject
	(*SubjectDetails)(nil),         // 32: cloudmind.core_api.SubjectDetails
	(*SubjectInfo)(nil),            // 33: cloudmind.core_api.SubjectInfo
	(*Label)(nil),                  // 34: cloudmind.core_api.Label
	(*LabelEntity)(nil),            // 35: cloudmind.core_api.LabelEntity
	(*ObjectFilterOptions)(nil),    // 36: cloudmind.core_api.ObjectFilterOptions
}
var file_cloudmind_core_api_common_proto_depIdxs = []int32{
	6,  // 0: cloudmind.core_api.PublicFile.author:type_name -> cloudmind.core_api.User
	20, // 1: cloudmind.core_api.PublicFile.fileCount:type_name -> cloudmind.core_api.PostCount
	21, // 2: cloudmind.core_api.PublicFile.fileRelation:type_name -> cloudmind.core_api.PostRelation
	14, // 3: cloudmind.core_api.SearchOptions.multiFieldsKey:type_name -> cloudmind.core_api.SearchField
