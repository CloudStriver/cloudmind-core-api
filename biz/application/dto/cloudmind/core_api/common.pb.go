...
type File struct {
	...
	Url         string `protobuf:"bytes,13,opt,name=url,proto3" json:"url" form:"url" query:"url"`
}
...
type FileInfo struct {
	...
	Author       *User         `protobuf:"bytes,16,opt,name=author,proto3" json:"author" form:"author" query:"author"`                         // 作者信息
	FileCount    *PostCount    `protobuf:"bytes,17,opt,name=fileCount,proto3" json:"fileCount" form:"fileCount" query:"fileCount"`             // 文章统计信息
	FileRelation *PostRelation `protobuf:"bytes,18,opt,name=fileRelation,proto3" json:"fileRelation" form:"fileRelation" query:"fileRelation"` // 文章关系信息
}
...
type FileFilterOptions struct {
	...
	OnlyDocumentType *int64   `protobuf:"varint,6,opt,name=onlyDocumentType,proto3,oneof" json:"onlyDocumentType" form:"onlyDocumentType" query:"onlyDocumentType"` // 操作类型 1：个人空间文件 2：公共空间文件
...
var file_cloudmind_core_api_common_proto_rawDesc = []byte{
	...
	0x65, 0x5f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x10, 0x02, 0x42, 0x53, 0x5a, 0x51, 0x67, 0x69,
