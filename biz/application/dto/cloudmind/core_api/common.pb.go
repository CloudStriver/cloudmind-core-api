...
type Notification struct {
	...
	Type       int64  `protobuf:"varint,1,opt,name=type,proto3" json:"type" form:"type" query:"type"`
	Text       string `protobuf:"bytes,2,opt,name=text,proto3" json:"text" form:"text" query:"text"`
	CreateTime int64  `protobuf:"varint,3,opt,name=createTime,proto3" json:"createTime" form:"createTime" query:"createTime"`
}
