...
type FileFilterOptions struct {
	...
	IsDel           *int64   `protobuf:"varint,6,opt,name=isDel,proto3,oneof" json:"isDel" form:"isDel" query:"isDel"`                       // 是否删除 1：未删除 2：软删除 3:彻底删除
	DocumentType    int64    `protobuf:"varint,7,opt,name=documentType,proto3" json:"documentType" form:"documentType" query:"documentType"` // 操作类型 1：个人空间文件 2：公共空间文件
...
type PostFilterOptions struct {
	...
	OnlyTitle  *string `protobuf:"bytes,3,opt,name=onlyTitle,proto3,oneof" json:"onlyTitle" form:"onlyTitle" query:"onlyTitle"`
	OnlyText   *string `protobuf:"bytes,4,opt,name=onlyText,proto3,oneof" json:"onlyText" form:"onlyText" query:"onlyText"`
	OnlyTag    *string `protobuf:"bytes,5,opt,name=onlyTag,proto3,oneof" json:"onlyTag" form:"onlyTag" query:"onlyTag"`
