...
type Notification struct {
	...
	FromName   string `protobuf:"bytes,1,opt,name=fromName,proto3" json:"fromName" form:"fromName" query:"fromName"`          // 通知来源人的名字
	FromId     string `protobuf:"bytes,2,opt,name=fromId,proto3" json:"fromId" form:"fromId" query:"fromId"`                  // 通知来源人的ID
	ToName     string `protobuf:"bytes,3,opt,name=toName,proto3" json:"toName" form:"toName" query:"toName"`                  // 通知接收人的名字
	ToId       string `protobuf:"bytes,4,opt,name=toId,proto3" json:"toId" form:"toId" query:"toId"`                          // 接收通知的ID
	ToType     int64  `protobuf:"varint,5,opt,name=toType,proto3" json:"toType" form:"toType" query:"toType"`                 // 接收通知人的类型
	Type       int64  `protobuf:"varint,6,opt,name=type,proto3" json:"type" form:"type" query:"type"`                         // 通知类型
	CreateTime int64  `protobuf:"varint,7,opt,name=createTime,proto3" json:"createTime" form:"createTime" query:"createTime"` // 通知创建时间
}
...
var file_cloudmind_core_api_common_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0xec, 0x02, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a,
	...
	0x19, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00,
	0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x88, 0x01, 0x01, 0x12, 0x2f, 0x0a, 0x05, 0x73, 0x74,
	...
	0x41, 0x74, 0x74, 0x72, 0x73, 0x52, 0x05, 0x61, 0x74, 0x74, 0x72, 0x73, 0x12, 0x16, 0x0a, 0x06,
	...
	0x22, 0xdf, 0x02, 0x0a, 0x0b, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x6b, 0x65, 0x22, 0xce, 0x03, 0x0a, 0x14, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x46, 0x69,
	...
	0x96, 0x02, 0x0a, 0x07, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x2e, 0x41, 0x74, 0x74, 0x72, 0x73, 0x52, 0x05, 0x61, 0x74, 0x74, 0x72, 0x73, 0x42, 0x0c, 0x0a,
...
var file_cloudmind_core_api_common_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_cloudmind_core_api_common_proto_goTypes = []interface{}{
	...
	(*Recommends)(nil),             // 37: cloudmind.core_api.Recommends
	(*Product)(nil),                // 38: cloudmind.core_api.Product
}
var file_cloudmind_core_api_common_proto_depIdxs = []int32{
	36, // 0: cloudmind.core_api.PublicFile.labels:type_name -> cloudmind.core_api.Label
