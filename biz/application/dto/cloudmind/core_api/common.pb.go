...
type Post struct {
	...
	ViewCount  int64    `protobuf:"varint,9,opt,name=viewCount,proto3" json:"viewCount" form:"viewCount" query:"viewCount"` // 浏览量
	CreateTime int64    `protobuf:"varint,15,opt,name=createTime,proto3" json:"createTime" form:"createTime" query:"createTime"`
	UpdateTime int64    `protobuf:"varint,16,opt,name=updateTime,proto3" json:"updateTime" form:"updateTime" query:"updateTime"`
}
...
type OwnPost struct {
	...
	LikeCount  int64    `protobuf:"varint,7,opt,name=likeCount,proto3" json:"likeCount" form:"likeCount" query:"likeCount"` // 点赞量
	ViewCount  int64    `protobuf:"varint,8,opt,name=viewCount,proto3" json:"viewCount" form:"viewCount" query:"viewCount"` // 浏览量
	CreateTime int64    `protobuf:"varint,9,opt,name=createTime,proto3" json:"createTime" form:"createTime" query:"createTime"`
	UpdateTime int64    `protobuf:"varint,10,opt,name=updateTime,proto3" json:"updateTime" form:"updateTime" query:"updateTime"`
}
