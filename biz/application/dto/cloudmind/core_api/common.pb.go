...
type File struct {
	...
	Tag         []string `protobuf:"bytes,10,rep,name=tag,proto3" json:"tag" form:"tag" query:"tag"`
	Description string   `protobuf:"bytes,11,opt,name=description,proto3" json:"description" form:"description" query:"description"`
	UpdateAt    int64    `protobuf:"varint,12,opt,name=updateAt,proto3" json:"updateAt" form:"updateAt" query:"updateAt"`
}
...
type FileInfo struct {
	...
	Description  string        `protobuf:"bytes,11,opt,name=description,proto3" json:"description" form:"description" query:"description"`
	UpdateAt     int64         `protobuf:"varint,12,opt,name=updateAt,proto3" json:"updateAt" form:"updateAt" query:"updateAt"`
	Author       *User         `protobuf:"bytes,13,opt,name=author,proto3" json:"author" form:"author" query:"author"`                         // 作者信息
	FileCount    *PostCount    `protobuf:"bytes,14,opt,name=fileCount,proto3" json:"fileCount" form:"fileCount" query:"fileCount"`             // 文章统计信息
	FileRelation *PostRelation `protobuf:"bytes,15,opt,name=fileRelation,proto3" json:"fileRelation" form:"fileRelation" query:"fileRelation"` // 文章关系信息
}
...
type FileFilterOptions struct {
	...
	OnlySetRelation  *int64   `protobuf:"varint,8,opt,name=OnlySetRelation,proto3,oneof" json:"OnlySetRelation" form:"OnlySetRelation" query:"OnlySetRelation"`
	OnlyMd5          *string  `protobuf:"bytes,9,opt,name=onlyMd5,proto3,oneof" json:"onlyMd5" form:"onlyMd5" query:"onlyMd5"`
}
...
type Post struct {
	...
	Url          string        `protobuf:"bytes,6,opt,name=url,proto3" json:"url" form:"url" query:"url"`
	Author       *User         `protobuf:"bytes,7,opt,name=author,proto3" json:"author" form:"author" query:"author"`                         // 作者信息
	PostCount    *PostCount    `protobuf:"bytes,8,opt,name=postCount,proto3" json:"postCount" form:"postCount" query:"postCount"`             // 文章统计信息
	PostRelation *PostRelation `protobuf:"bytes,9,opt,name=postRelation,proto3" json:"postRelation" form:"postRelation" query:"postRelation"` // 文章关系信息
...
var file_cloudmind_core_api_common_proto_rawDesc = []byte{
	...
	0x01, 0x12, 0x09, 0x0a, 0x05, 0x77, 0x6f, 0x6d, 0x65, 0x6e, 0x10, 0x02, 0x42, 0x53, 0x5a, 0x51,
