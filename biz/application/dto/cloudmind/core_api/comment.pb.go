...
type GetCommentsReq struct {
	...
	FilterOptions *CommentFilterOptions    `protobuf:"bytes,1,opt,name=filterOptions,proto3,oneof" json:"filterOptions" form:"filterOptions" query:"filterOptions"`
	Pagination    *basic.PaginationOptions `protobuf:"bytes,2,opt,name=pagination,proto3,oneof" json:"pagination" form:"pagination" query:"pagination"`
}
...
type GetLabelsReq struct {
	...
	Pagination *basic.PaginationOptions `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination" form:"pagination" query:"pagination"`
}
...
type GetObjectsReq struct {
	...
	FilterOptions *ObjectFilterOptions     `protobuf:"bytes,1,opt,name=filterOptions,proto3" json:"filterOptions" form:"filterOptions" query:"filterOptions"`
	Pagination    *basic.PaginationOptions `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination" form:"pagination" query:"pagination"`
}
...
var file_cloudmind_core_api_comment_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x42, 0x53, 0x5a,
