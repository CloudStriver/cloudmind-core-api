...
type GetNotificationsReq struct {
	...
	OnlyIsRead *bool   `protobuf:"varint,2,opt,name=onlyIsRead,proto3,oneof" json:"onlyIsRead" form:"onlyIsRead" query:"onlyIsRead"`
...
type GetNotificationCountReq struct {
	...
	OnlyType   *int64 `protobuf:"varint,2,opt,name=onlyType,proto3,oneof" json:"onlyType" form:"onlyType" query:"onlyType"`
	OnlyIsRead *bool  `protobuf:"varint,3,opt,name=onlyIsRead,proto3,oneof" json:"onlyIsRead" form:"onlyIsRead" query:"onlyIsRead"`
}
...
type DeleteNotificationsReq struct {
	...
	OnlyNotificationIds []string `protobuf:"bytes,1,rep,name=onlyNotificationIds,proto3" json:"onlyNotificationIds" form:"onlyNotificationIds" query:"onlyNotificationIds"`
	OnlyType            *int64   `protobuf:"varint,2,opt,name=onlyType,proto3,oneof" json:"onlyType" form:"onlyType" query:"onlyType"`
	OnlyIsRead          *bool    `protobuf:"varint,3,opt,name=onlyIsRead,proto3,oneof" json:"onlyIsRead" form:"onlyIsRead" query:"onlyIsRead"`
}
