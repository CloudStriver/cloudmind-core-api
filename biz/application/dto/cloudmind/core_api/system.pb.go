...
type GetNotificationsReq struct {
	...
	OnlyType  *int64  `protobuf:"varint,1,opt,name=onlyType,proto3,oneof" json:"onlyType" form:"onlyType" query:"onlyType" vd:"($ == nil) || ($>=1 && $ <= 5)"`
...
type DeleteNotificationsReq struct {
	...
	NotificationIds []string `protobuf:"bytes,1,rep,name=notificationIds,proto3" json:"notificationIds" form:"notificationIds" query:"notificationIds"`
	OnlyType        *int64   `protobuf:"varint,2,opt,name=onlyType,proto3,oneof" json:"onlyType" form:"onlyType" query:"onlyType" vd:"($ == nil) || ($>=1 && $ <= 5)"`
}
...
type CreateSliderReq struct {
	...
	IsPublic int64  `protobuf:"varint,3,opt,name=isPublic,proto3" json:"isPublic" form:"isPublic" query:"isPublic" vd:"$ >= 1 && $ <= 2"` // 是否公开
}
...
type UpdateSliderReq struct {
	...
	IsPublic int64  `protobuf:"varint,4,opt,name=isPublic,proto3" json:"isPublic" form:"isPublic" query:"isPublic" vd:"$ >= 1 && $ <= 2"`
}
...
var file_cloudmind_core_api_system_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x42, 0x53, 0x5a, 0x51, 0x67, 0x69, 0x74, 0x68, 0x75,
