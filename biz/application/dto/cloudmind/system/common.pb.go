...
type Notification struct {
	...
	TargetType      int64  `protobuf:"varint,5,opt,name=targetType,proto3" json:"targetType" form:"targetType" query:"targetType"`
...
type NotificationInfo struct {
	...
	TargetUserId    string `protobuf:"bytes,1,opt,name=targetUserId,proto3" json:"targetUserId" form:"targetUserId" query:"targetUserId"`
	...
	TargetType      int64  `protobuf:"varint,4,opt,name=targetType,proto3" json:"targetType" form:"targetType" query:"targetType"`
	Type            int64  `protobuf:"varint,5,opt,name=type,proto3" json:"type" form:"type" query:"type"`
...
var file_cloudmind_system_common_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x6d, 0x69, 0x6e, 0x64, 0x2f, 0x73, 0x79, 0x73,
