...
type User struct {
	...
	Role     int32  `protobuf:"varint,2,opt,name=role,proto3" json:"role" form:"role" query:"role"`
...
type Auth struct {
	...
	AuthType int32  `protobuf:"varint,1,opt,name=authType,proto3" json:"authType" form:"authType" query:"authType"`
...
type Point struct {
	...
	X int32 `protobuf:"varint,1,opt,name=x,proto3" json:"x" form:"x" query:"x"`
	Y int32 `protobuf:"varint,2,opt,name=y,proto3" json:"y" form:"y" query:"y"`
}
...
type Captcha struct {
	...
	Point *Point `protobuf:"bytes,1,opt,name=point,proto3" json:"point" form:"point" query:"point"`
...
var file_cloudmind_sts_common_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x05, 0x41, 0x70, 0x70, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x75, 0x6e, 0x69, 0x6f,
	...
	0x79, 0x70, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x41, 0x70, 0x70, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x41, 0x70, 0x70, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x75, 0x6e, 0x69,
	...
	0x10, 0x02, 0x12, 0x08, 0x0a, 0x04, 0x74, 0x65, 0x73, 0x74, 0x10, 0x03, 0x42, 0x4e, 0x5a, 0x4c,
	...
	0x6c, 0x6f, 0x75, 0x64, 0x6d, 0x69, 0x6e, 0x64, 0x2f, 0x73, 0x74, 0x73, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
