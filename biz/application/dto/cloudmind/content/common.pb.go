...
type Item struct {
	...
	Categories []string `protobuf:"bytes,4,rep,name=categories,proto3" json:"categories" form:"categories" query:"categories"`
	Timestamp  string   `protobuf:"bytes,5,opt,name=timestamp,proto3" json:"timestamp" form:"timestamp" query:"timestamp"`
	Comment    string   `protobuf:"bytes,6,opt,name=comment,proto3" json:"comment" form:"comment" query:"comment"`
}
...
type FeedBack struct {
	...
	Timestamp    string `protobuf:"bytes,4,opt,name=timestamp,proto3" json:"timestamp" form:"timestamp" query:"timestamp"`
}
...
var file_cloudmind_content_common_proto_rawDesc = []byte{
	...
	0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x74, 0x41, 0x73, 0x63, 0x10, 0x04, 0x42, 0x52,
	0x5a, 0x50, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x43, 0x6c, 0x6f,
