...
type File struct {
	...
	IsDel       int32    `protobuf:"varint,9,opt,name=isDel,proto3" json:"isDel" form:"isDel" query:"isDel"`
...
type FileFilterOptions struct {
	...
	OnlyFileType *int32  `protobuf:"varint,4,opt,name=onlyFileType,proto3,oneof" json:"onlyFileType" form:"onlyFileType" query:"onlyFileType"` // 文件类型
	IsDel        int32   `protobuf:"varint,5,opt,name=isDel,proto3" json:"isDel" form:"isDel" query:"isDel"`                                   // 是否删除 1：未删除 2：软删除 3:彻底删除
	DocumentType int32   `protobuf:"varint,6,opt,name=documentType,proto3" json:"documentType" form:"documentType" query:"documentType"`       // 操作类型 1：个人空间文件 2：公共空间文件
}
...
type UserDetail struct {
	...
	UserId      string `protobuf:"bytes,1,opt,name=userId,proto3" json:"userId" form:"userId" query:"userId"`
	Name        string `protobuf:"bytes,2,opt,name=name,proto3" json:"name" form:"name" query:"name"`
	Sex         int32  `protobuf:"varint,3,opt,name=sex,proto3" json:"sex" form:"sex" query:"sex"`
...
type UserDetailInfo struct {
	...
	UserId      string `protobuf:"bytes,1,opt,name=userId,proto3" json:"userId" form:"userId" query:"userId"`
	Name        string `protobuf:"bytes,2,opt,name=name,proto3" json:"name" form:"name" query:"name"`
	Sex         Sex    `protobuf:"varint,3,opt,name=sex,proto3,enum=cloudmind.content.Sex" json:"sex" form:"sex" query:"sex"`
	FullName    string `protobuf:"bytes,4,opt,name=fullName,proto3" json:"fullName" form:"fullName" query:"fullName"`
	IdCard      string `protobuf:"bytes,5,opt,name=idCard,proto3" json:"idCard" form:"idCard" query:"idCard"`
...
var file_cloudmind_content_common_proto_rawDesc = []byte{
	...
	0x02, 0x42, 0x52, 0x5a, 0x50, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
