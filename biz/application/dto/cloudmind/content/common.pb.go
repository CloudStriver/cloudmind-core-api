...
type ShareFile struct {
	...
	UserId        string   `protobuf:"bytes,2,opt,name=userId,proto3" json:"userId" form:"userId" query:"userId"`
	Name          string   `protobuf:"bytes,3,opt,name=name,proto3" json:"name" form:"name" query:"name"`
	Status        Status   `protobuf:"varint,4,opt,name=status,proto3,enum=cloudmind.content.Status" json:"status" form:"status" query:"status"`
	Limit         int64    `protobuf:"varint,5,opt,name=limit,proto3" json:"limit" form:"limit" query:"limit"`
	Persons       []string `protobuf:"bytes,6,rep,name=persons,proto3" json:"persons" form:"persons" query:"persons"`
	EffectiveTime int64    `protobuf:"varint,7,opt,name=effectiveTime,proto3" json:"effectiveTime" form:"effectiveTime" query:"effectiveTime"`
	BrowseNumber  int64    `protobuf:"varint,8,opt,name=browseNumber,proto3" json:"browseNumber" form:"browseNumber" query:"browseNumber"`
	CreateAt      int64    `protobuf:"varint,9,opt,name=createAt,proto3" json:"createAt" form:"createAt" query:"createAt"`
	FileList      []string `protobuf:"bytes,10,rep,name=fileList,proto3" json:"fileList" form:"fileList" query:"fileList"`
}
...
type FileFilterOptions struct {
	...
	IsDel        int64   `protobuf:"varint,5,opt,name=isDel,proto3" json:"isDel" form:"isDel" query:"isDel"`                                   // 是否删除 1：未删除 2：软删除 3:彻底删除
	DocumentType int64   `protobuf:"varint,6,opt,name=documentType,proto3" json:"documentType" form:"documentType" query:"documentType"`       // 操作类型 1：个人空间文件 2：公共空间文件
}
...
var file_cloudmind_content_common_proto_rawDesc = []byte{
	...
	0x12, 0x09, 0x0a, 0x05, 0x77, 0x6f, 0x6d, 0x65, 0x6e, 0x10, 0x02, 0x42, 0x52, 0x5a, 0x50, 0x67,
