...
type File struct {
	...
	Type        Type   `protobuf:"varint,5,opt,name=type,proto3,enum=cloudmind.content.Type" json:"type" form:"type" query:"type"`
...
type FileFilterOptions struct {
	...
	OnlyTypeString   []string `protobuf:"bytes,9,rep,name=onlyTypeString,proto3" json:"onlyTypeString" form:"onlyTypeString" query:"onlyTypeString"`
}
...
type Coupon struct {
	...
	Desciption    string `protobuf:"bytes,8,opt,name=desciption,proto3" json:"desciption" form:"desciption" query:"desciption"`
...
var file_cloudmind_content_common_proto_rawDesc = []byte{
	...
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x74, 0x41, 0x73, 0x63, 0x10, 0x04, 0x42, 0x52, 0x5a,
	0x50, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x43, 0x6c, 0x6f, 0x75,
