...
type Comment struct {
	...
	State      State    `protobuf:"varint,6,opt,name=state,proto3,enum=platform.comment.State" json:"state" form:"state" query:"state"` // 1: 正常, 2: 删除
	Attrs      Attrs    `protobuf:"varint,7,opt,name=attrs,proto3,enum=platform.comment.Attrs" json:"attrs" form:"attrs" query:"attrs"` // 1: 无, 2: 置顶, 3: 精华, 4: 置顶+精华
	Tags       []string `protobuf:"bytes,8,rep,name=tags,proto3" json:"tags" form:"tags" query:"tags"`                                  // 标签：作者点赞，作者回复等
...
type Subject struct {
	...
	State        State  `protobuf:"varint,7,opt,name=state,proto3,enum=platform.comment.State" json:"state" form:"state" query:"state"` // 1: 正常, 2: 删除
	Attrs        Attrs  `protobuf:"varint,8,opt,name=attrs,proto3,enum=platform.comment.Attrs" json:"attrs" form:"attrs" query:"attrs"` // 1: 无, 2: 置顶, 3: 精华, 4: 置顶+精华
}
...
var file_platform_comment_common_proto_rawDesc = []byte{
	...
	0x64, 0x74, 0x6f, 0x2f, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x2f, 0x63, 0x6f, 0x6d,
